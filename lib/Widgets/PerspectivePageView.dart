  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Center(
        child: AspectRatio(
          //confusion
          aspectRatio: double.tryParse(arAndShadow[0].toString())!,
            ...
            child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  return MyPage(
                    ...
                    shadowScale: double.tryParse(arAndShadow[0].toString())!,
                  );
                }),
          ),
        ),
            ...
            child: Transform(
              ...
              child: Container(
                decoration: BoxDecoration(boxShadow: [
                  BoxShadow(
                      color: shadowColor, blurRadius: 10.0, spreadRadius: 1.0)
                ]),
              ),
            ),
          ),
